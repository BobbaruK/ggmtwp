...
/**
  * @package cssecoST
  * includes/front/template-parts/products/products_section1.php
  */
?>

<section id="section1" class="products_section1 top">
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 col-xl-6 text-center">
        <img src="<?php echo get_template_directory_uri() ?>/dist/imgs/products/products/section1/shipment.png" alt="Shipment">
      </div>
    </div>
  </div>
</section>