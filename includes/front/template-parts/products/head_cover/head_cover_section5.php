...
/**
  * @package cssecoST
  * includes/front/template-parts/products/head_cover/head_cover_section5.php
  */
?>

<section id="section5" class="headCoverMaterials">
  <div class="container">
    <div class="row">
      <div class="col-12">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-6 col-xl-4">
        <h3>SPL</h3>
        <div class="desc">
          <p><strong>Spunlace</strong> is a non-woven fiber created by bonding a web of loose fibers using high pressure water jets.  The result is a soft, lightweight, durable, semi-elastic material..</p>
          <ul>
