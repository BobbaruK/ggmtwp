...
/**
  * @package cssecoST
  * includes/front/template-parts/products/head_cover/head_cover_section1.php
  */
?>

<section id="section1" class="section1 headcover">
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6 d-md-flex flex-column justify-content-between">
        <h1 class="bull"><span>Head Coverings</span></h1>
      ...
      <div class="col-12 col-md-6 d-md-flex align-items-center justify-content-center">
        <img src="<?php echo get_template_directory_uri() ?>/dist/imgs/products/disposable_gowns/section1/wqad.png" alt="Map">
      </div>
    </div>
  </div>
</section>