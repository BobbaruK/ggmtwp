...
/**
  * @package cssecoST
  * includes/front/template-parts/products/shoe_cover/shoe_cover_section1.php
  */
?>

<section id="section1" class="products_section1 disposablegowns">
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6 d-md-flex flex-column justify-content-between">
        <h1 class="bull"><span>Shoe Covers</span></h1>
      ...
      <div class="col-12 col-md-6 d-md-flex align-items-center justify-content-center">
        <img src="<?php echo get_template_directory_uri() ?>/dist/imgs/products/shoe_cover/section1/sc.png" alt="Map">
      </div>
    </div>
  </div>
</section>