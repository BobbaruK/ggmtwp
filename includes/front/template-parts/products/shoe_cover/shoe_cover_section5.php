...
/**
  * @package cssecoST
  * includes/front/template-parts/products/shoe_cover/shoe_cover_section5.php
  */
?>

<section id="section5" class="materials shoeCoverMaterials">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2>Shoe Cover Materials</h2>
      </div>
    </div>
    <div class="row">
