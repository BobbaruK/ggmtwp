...
/**
  * @package cssecoST
  * includes/front/template-parts/products/surgical_masks/surgical_masks_section1.php
  */
?>

<section id="section1" class="products_section1 faceMasks">
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6 d-md-flex flex-column justify-content-between">
        <h1 class="bull"><span>Face Masks</span></h1>
      ...
      <img src="<?php echo get_template_directory_uri() ?>/dist/imgs/products/surgical_masks/section1/1.png" alt="">
      </div>
    </div>
  </div>
</section>