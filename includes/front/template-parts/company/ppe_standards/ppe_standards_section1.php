...
<section id="section1" class="products_section1">
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6 d-md-flex flex-column justify-content-between">
        <h1 class="bull"><span>PPE Standards And Certifications</span></h1>
      ...
      <div class="col-12 col-md-6 d-md-flex align-items-center justify-content-center">
        <img src="<?php echo get_template_directory_uri() ?>/dist/imgs/company/ppe_standards/section1/1.png" alt="">
      </div>
    </div>
  </div>
</section>