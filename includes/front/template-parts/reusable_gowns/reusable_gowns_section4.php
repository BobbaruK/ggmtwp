...
/**
  * @package cssecoST
  * includes/front/template-parts/reusable_gowns/reusable_gowns_section4.php
  */
?>
...
<section id="section4" class="reusablePpeTypes">
        ...
        <div class="col-12 col-lg-6">
          <div class="txtWrapper">
            <div class="img_wrapper">
              <img class="fastenings_image" src="<?php echo get_template_directory_uri() ?>/dist/imgs/gowns/reusable_gowns/section4/repellant_gowns.png" alt="">
            </div>
            ...
            <table class="table table-bordered">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <ul>
                      <li>Knit Cuff / Straight Cuff</li>
                      <li>Back Tie / Waist tie</li>
                      <li>Overlap Back / Backless</li>
                      <li>Sizes S - XL</li>
                    </ul>
                  </td>
                </tr>
    ...
    <div class="container">
      <div class="row">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <ul>
                      <li>55% Cotton / 45% Polyester</li>
                      <li>99% Polyester / 1% Carbon Nanofiber (Autoclavable)</li>
                    </ul>
                  </td>
                </tr>
                <tr>
        ...
        <div class="col-12 col-lg-6 order-1 order-lg-2">
          <div class="txtWrapper">
            <div class="img_wrapper">
              <img class="fastenings_image" src="<?php echo get_template_directory_uri() ?>/dist/imgs/gowns/reusable_gowns/section4/gowns.png" alt="">
            </div>
            <h3>Gowns</h3>
  ...
  <section id="section4-3" class="headCovers">
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-6">
          <div class="txtWrapper">
            <div class="img_wrapper">
              <img class="fastenings_image" src="<?php echo get_template_directory_uri() ?>/dist/imgs/gowns/reusable_gowns/section4/head_covers.png" alt="">
            </div>
            <h3>Head Covers</h3>
