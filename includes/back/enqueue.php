...
function csseco_load_admin_scripts( $hook ) {
	...
	// styles
	wp_register_style( 'csseco_admin', get_template_directory_uri() . '/dist/css/csseco.admin.css', array(), '1.0.0', 'all' );
	wp_enqueue_style ( 'csseco_admin' );
	
	// scripts
	wp_enqueue_media();
	
	wp_register_script ( 'csseco_admin_script', get_template_directory_uri() . 'dist/js/csseco-scripts.min', array('jquery'), '1.0.0', true );
